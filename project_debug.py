...
debugRegionUpper.insert(layout_waveguide_from_points(TOP, workingLayer, bendPoints, upperPinW, braggBendRadius))
debugRegionLower.insert(layout_waveguide_from_points(TOP, workingLayer, bendPoints, cPinW, braggBendRadius))

debugCPW = debugRegionUpper - debugRegionLower
TOP.shapes(outputLayer).insert(debugCPW)
